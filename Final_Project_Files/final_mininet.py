...
def BeginSimulation() :
    ...
    c0 = RemoteController( 'c0', ip='192.168.56.1', port=6633 )  #This is parent controller (change tomcat 8081)
    c1 = RemoteController( 'c1', ip='192.168.56.20', port=6633 )
    c2 = RemoteController( 'c2', ip='192.168.56.21', port=6633 )
