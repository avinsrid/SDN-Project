...
public class RecA implements IRouting, ITopologyManager {
    ...
    private int MasterPort = 41201; // Use 41101 / 41201 for 2 different child controllers
        ...
        while (true)
        {
            if (System.currentTimeMillis() - Timer > pollTime)
            {
                ...
                for(Node checkNode : allNodes) {
                    ...
                    for(Edge edgeCheck : NodeEdges)
                    {
                        ...
                        try {
                            ...
                            if(!NodeEdges.contains(edgeReverse))
                            {
                                ...
                                {
                                    System.out.println("Reca::RecaImplementation(): Reverse edge Not present, Add to map : ");
                            ...
                            System.out.println("Reca::RecaImplementation(): Exception to create edge!");
                        }
                    }
                    ...
                    {
                        NodeEdges = edgesForEachNode.get(checkNode);
                        System.out.println("Reca::RecaImplementation() NodeEdges are : " + NodeEdges + "\nextraEdge is :" + extraEdge);
