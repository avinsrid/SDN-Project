package project.sdn.portdiscover;
...
public class PortDiscovery {
	...
	public static void main(String args[]) {
		...
		JSONObject topology = getTopology("admin","admin","http://192.168.56.102:8080/controller/nb/v2/topology/default");
        // Print the obtained JSON data from parent controller
